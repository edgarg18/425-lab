...
uint8_t PMOD_BTN_Read(void)
{
	...
	// Return the state of the PMOD BTN module
	return pmod_btn_state;
}

void GPIOA_Handler(void)
{
	// Check if an interrupt has been triggered by ani=y oif 
	// the following pins: PA5, PA4, PA3, PA2
	if (GPIOA->MIS & 0x3c)
	{
		// Excecute the user defined function 
		(*PMOD_BTN_Task)(PMOD_BTN_Read());
		
		// Ackniwkedge the interrupt from any of the following pins
		// and clear it: PA5, PA4, PA3, PA2
		GPIOA->ICR |= 0x3C;
	}
