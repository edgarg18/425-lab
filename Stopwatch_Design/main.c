...
int main(void)
{
	...
	// Initialize Timer 0A to generate periodic interrupts evry 1 ms
...
void Calculate_Stopwatch_Value(uint8_t stopwatch_value[])
{
	// Sote "milliseconds" value in the first index of the array
