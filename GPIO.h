...
/**
 * @brief The Change_Counter_Speed(uint8_t button_status); takes in an unsigned 8-bit integer (uint8_t) parameter called button_status
 *
 * returns an unsigned 32-bit value variable (uint32_t) called toggle_rate_ms. This function
will update the toggle rate of the Timer_0A_Periodic_Task function in milliseconds
based on the status of the EduBase board push buttons.
 *
 * @param None
 *
 * @return Indicates the status of the buttons. 
